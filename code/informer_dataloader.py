...
def informer_dataloader_weather(*args, **kwargs):
    ...
    return informer_model(*args, **kwargs)

def informer_dataloader_traffic(*args, **kwargs):
...
def informer_dataloader_illness(*args, **kwargs):
...
def informer_dataloader_electricity(*args, **kwargs):
...
def informer_dataloader_exchange(*args, **kwargs):
...
def informer_dataloader_ettm2(*args, **kwargs):
...
def informer_model(history_length, horizon_length, device, args, keep_dims,
    ...
    from models.other.Informer2020_.data.data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom,\
            Dataset_Pred

...
def fedformer_dataloader_weather(*args, **kwargs):
    ...
    return fedformer_model(*args, **kwargs)

def fedformer_dataloader_traffic(*args, **kwargs):
...
def fedformer_dataloader_illness(*args, **kwargs):
...
def fedformer_dataloader_electricity(*args, **kwargs):
...
def fedformer_dataloader_exchange(*args, **kwargs):
...
def fedformer_dataloader_ettm2(*args, **kwargs):
...
def fedformer_model(history_length, horizon_length, device, args, keep_dims,
    ...
    from models.other.FEDformer_.data_provider.data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom,\
            Dataset_Pred

...
batch_size=100
# This was not supposed to be called redo
experiment_batch_name=informer_multivariate
experiment_prepend=informer_multivariate
model_name=Informer
...
dec_in=21
c_out=21
dataset=informer_dataloader_weather
...
dec_in=862
c_out=862
dataset=informer_dataloader_traffic
for horizon_length in 96 192 336 720; do
...
dec_in=7
c_out=7
dataset=informer_dataloader_illness
...
dec_in=321
c_out=321
dataset=informer_dataloader_electricity
for horizon_length in 96 192 336 720; do
...
dec_in=8
c_out=8
dataset=informer_dataloader_exchange
for horizon_length in 96 192 336 720; do
...
dec_in=7
c_out=7
dataset=informer_dataloader_ettm2
for horizon_length in 96 192 336 720; do
